package com.rentalsforshare.common.custom;
...
public class CustomizationBean implements EmbeddedServletContainerCustomizer {
	...
	public void customize(ConfigurableEmbeddedServletContainer container) {
		...
		container.addErrorPages(new ErrorPage(HttpStatus.UNAUTHORIZED, Constants.STR_PATH_NOT_FOUND));
		container.addErrorPages(
				new ErrorPage(HttpStatus.INTERNAL_SERVER_ERROR, Constants.STR_PATH_INTERNAL_SERVER_ERROR));
	}
}